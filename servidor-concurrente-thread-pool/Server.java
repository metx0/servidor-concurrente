...
public class Server {
    ...
    // Número máximo de hilos que puede ejecutar el thread pool
    private static final int maxHilos = 12;
    ...
    public static void main(String[] args) {
        ExecutorService threadPool = Executors.newFixedThreadPool(maxHilos);      
        ...
        try (ServerSocket serverSocket = new ServerSocket(puerto)) {
            ...
            while (true) {
                ...
                threadPool.submit(new HiloManejador(socket, numeroClientes));
            }
        } catch (IOException e) {
            System.out.println("Ha ocurrido una excepción de I/O");
        }
